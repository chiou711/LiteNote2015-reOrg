...
public class MainUi 
{
                    ...
                    public void onClick(DialogInterface dialog, int which)
                    {
						...
						.setSingleChoiceItems(items, -1, new DialogInterface.OnClickListener()
						{
							...
							if(which == 0)
							{
								...
								Util.setPref_lastTimeView_tabsTableId(act,db.getTabsTableId(DrawerActivity.mFocus_drawerChildPos) );
	...
	static void shiftPage(final Activity act)
	{
	    ...
	    {  @Override
	       public void onClick(View v)
	       {
	    	    ...
	    	    {
	    	    	Util.setPref_lastTimeView_notesTableId(act, TabsHostFragment.mDbTabs.getNotesTableId(TabsHostFragment.mCurrent_tabIndex, true));
	    ...
	    {  @Override
	       public void onClick(View v)
	       {
	    		...
	    		d.getButton(AlertDialog.BUTTON_NEGATIVE).setEnabled(true);
	   	    	...
	   	    	{
	    	    	Util.setPref_lastTimeView_notesTableId(act, db.getNotesTableId(TabsHostFragment.mCurrent_tabIndex, true));
	...
	static void insertTabRightmost(final FragmentActivity act, int newTblId,String tabName)
	{
		...
		Util.setPref_lastTimeView_notesTableId(act, newTblId);
...
//		Context context = act.getApplicationContext();
		...
		for(int i =0;i<dbTabs.getTabsCount(false);i++)
		{
	    	...
	    	if(	dbTabs.getTabId(i, false)== TabsHostFragment.mFirstExist_TabId)
	    	{
	    		...
	    		Util.setPref_lastTimeView_notesTableId(act, dbTabs.getNotesTableId(i, false) );
	    	}
		}
		dbTabs.doCloseTabs();
	}
	...
	public static void deleteSelectedDrawer(int position, final Activity act) 
	{
        ...
        Util.setPref_lastTimeView_tabsTableId(act,
...
//		System.out.println("mLastExist_drawerTabsTableId = " + mLastExist_drawerTabsTableId);
    ...
    static Runnable mTabsHostRun =  new Runnable() 
    {
        ...
        public void run() 
        {
            ...
            //09-11 00:40:49.634: E/AndroidRuntime(28200): java.lang.IllegalStateException: Can not perform this action after onSaveInstanceState
...
class DrawerItemClickListener implements OnItemClickListener 
{
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) 
    {
    	...
    	DB db = DB.mDb_drawer;
        Util.setPref_lastTimeView_tabsTableId(DrawerActivity.mDrawerActivity,
