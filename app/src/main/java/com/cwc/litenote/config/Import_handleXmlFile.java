	            ...
	            case XmlPullParser.END_TAG:
		           if(name.equals("tabname"))
		           {
	                  ...
	                  if(mEnableInsertDB)
	                  {
			        	  ...
			        	  DB.insertNotesTable(mDb,DB.getFocus_tabsTableId(),TabsHostFragment.getLastTabId() + 1, false );
	               ...
	               { 	
	            	  ...
	            	  if(mEnableInsertDB)
	            	  {
		            	  DB.setFocus_notes_tableId(String.valueOf(TabsHostFragment.getLastTabId()));  
