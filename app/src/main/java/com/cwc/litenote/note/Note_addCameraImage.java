...
//      String timeStamp = new SimpleDateFormat("yyyyMMdd_HHmmss", Locale.US).format(new Date());
        ...
        System.out.println("+++ _createTempImageFile / imageFile path = " + imageFile.getPath());
        return imageFile;
    }
...
*/
				...
				handleDuplictedImage(this, lastContentId);
    			
        		// show confirm Continue dialog
	        	if(pref_takeImage.getString("KEY_SHOW_CONFIRMATION_DIALOG","yes").equalsIgnoreCase("yes"))
	        	{
	    			 bUseCameraImage = true; 
...
//				findViewById(android.R.id.content).setVisibility(View.INVISIBLE);
	...
	public static void handleDuplictedImage(Context context, int lastContentId) 
	{
	    /*
